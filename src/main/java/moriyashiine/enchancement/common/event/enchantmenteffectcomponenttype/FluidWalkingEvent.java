...
public class FluidWalkingEvent implements PreventFallDamageEvent {
	...
	public TriState preventsFallDamage(World world, LivingEntity entity, double fallDistance, float damagePerDistance, DamageSource damageSource) {
		if (fallDistance > entity.getSafeFallDistance() && !world.getFluidState(entity.getSteppingPos()).isEmpty() && EnchancementUtil.hasAnyEnchantmentsWith(entity, ModEnchantmentEffectComponentTypes.FLUID_WALKING)) {
