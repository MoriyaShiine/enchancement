...
public class EnchancementEntityTypeTags {
	...
	public static final TagKey<EntityType<?>> CANNOT_FLUID_WALK = TagKey.create(Registries.ENTITY_TYPE, Enchancement.id("cannot_fluid_walk"));
