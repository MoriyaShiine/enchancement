...
public class EnchancementEnchantmentEffectComponentTypes {
	...
	public static final DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>> DISABLE_BLOCKING = registerEnchantmentEffectComponentType("disable_blocking", builder -> builder.persistent(validatedListCodec(ConditionalEffect.codec(EnchantmentValueEffect.CODEC), LootContextParamSets.ENCHANTED_ITEM)));
	...
	public static final DataComponentType<EMeterEffect> E_METER = registerEnchantmentEffectComponentType("e_meter", builder -> builder.persistent(EMeterEffect.CODEC));
	...
	public static final DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>> HEADSHOT = registerEnchantmentEffectComponentType("headshot", builder -> builder.persistent(validatedListCodec(ConditionalEffect.codec(EnchantmentValueEffect.CODEC), LootContextParamSets.ENCHANTED_ITEM)));
