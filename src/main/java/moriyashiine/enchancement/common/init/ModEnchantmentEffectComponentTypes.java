...
public class ModEnchantmentEffectComponentTypes {
	...
	public static final DataComponentType<EnchantmentValueEffect> E_METER = registerEnchantmentEffectComponentType("e_meter", builder -> builder.persistent(EnchantmentValueEffect.CODEC));
