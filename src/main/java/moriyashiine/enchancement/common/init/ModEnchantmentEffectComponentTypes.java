...
public class ModEnchantmentEffectComponentTypes {
	...
	public static final ComponentType<List<EnchantmentEffectEntry<CriticalTipperEffect>>> CRITICAL_TIPPER = register("critical_tipper", builder -> builder.codec(EnchantmentEffectEntry.createCodec(CriticalTipperEffect.CODEC, LootContextTypes.ENCHANTED_ITEM).listOf()));
