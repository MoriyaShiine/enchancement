...
public class ModEnchantmentEffectComponentTypes {
	...
	public static final DataComponentType<Unit> HIDE_LABEL_BEHIND_WALLS = registerEnchantmentEffectComponentType("hide_label_behind_walls", builder -> builder.persistent(Unit.CODEC));
	...
	public static final DataComponentType<List<ConditionalEffect<EnchantmentValueEffect>>> PHASE_THROUGH_BLOCKS_AND_FLOAT = registerEnchantmentEffectComponentType("phase_through_blocks_and_float", builder -> builder.persistent(validatedListCodec(ConditionalEffect.codec(EnchantmentValueEffect.CODEC), LootContextParamSets.ENCHANTED_ITEM)));
