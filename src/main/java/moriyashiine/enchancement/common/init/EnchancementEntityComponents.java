...
import moriyashiine.enchancement.common.component.entity.config.*;
import moriyashiine.enchancement.common.component.entity.enchantmenteffectcomponenttype.*;
import moriyashiine.enchancement.common.component.entity.enchantmenteffecttype.ConditionalAttributesComponent;
...
public class EnchancementEntityComponents implements EntityComponentInitializer {
	// config
	...
	public static final ComponentKey<IgnitedComponent> IGNITED = ComponentRegistry.getOrCreate(Enchancement.id("ignited"), IgnitedComponent.class);
	...
	public void registerEntityComponentFactories(EntityComponentFactoryRegistry registry) {
		...
		registry.registerFor(LivingEntity.class, IGNITED, IgnitedComponent::new);
