...
public class ModSoundEvents {
	...
	public static void init() {
		...
		Registry.register(Registries.SOUND_EVENT, ENTITY_GENERIC_ERUPT.getId(), ENTITY_GENERIC_ERUPT);
		...
		Registry.register(Registries.SOUND_EVENT, ENTITY_GENERIC_ZAP.getId(), ENTITY_GENERIC_ZAP);
