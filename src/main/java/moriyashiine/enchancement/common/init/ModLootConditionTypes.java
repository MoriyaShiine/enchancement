...
public class ModLootConditionTypes {
	...
	public static final LootConditionType IN_COMBAT = new LootConditionType(InCombatLootCondition.CODEC);
	...
	public static void init() {
		...
		Registry.register(Registries.LOOT_CONDITION_TYPE, Enchancement.id("in_combat"), IN_COMBAT);
