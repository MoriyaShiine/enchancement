...
public class EnchantedToolsHaveEfficiencyEvent implements ItemTooltipCallback {
	...
	public void getTooltip(ItemStack stack, Item.TooltipContext tooltipContext, TooltipType tooltipType, List<Text> lines) {
		if (ModConfig.enchantedToolsHaveEfficiency && stack.hasEnchantments() && stack.isIn(ItemTags.MINING_ENCHANTABLE) && stack.contains(ModComponentTypes.TOGGLEABLE_PASSIVE)) {
