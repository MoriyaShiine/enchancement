...
public class EnchantedTridentsHaveLoyalty implements ItemTooltipCallback {
	...
	public void getTooltip(ItemStack stack, Item.TooltipContext tooltipContext, TooltipType tooltipType, List<Text> lines) {
		if (ModConfig.enchantedTridentsHaveLoyalty && stack.hasEnchantments() && stack.isIn(ItemTags.TRIDENT_ENCHANTABLE) && stack.contains(ModDataComponentTypes.TOGGLEABLE_PASSIVE)) {
