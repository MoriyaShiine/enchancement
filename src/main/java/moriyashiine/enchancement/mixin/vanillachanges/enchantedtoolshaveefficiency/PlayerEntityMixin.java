...
public class PlayerEntityMixin {
	...
	private double enchancement$enchantedToolsHaveEfficiency(PlayerEntity instance, RegistryEntry<EntityAttribute> registryEntry, Operation<Double> original) {
		double speed = original.call(instance, registryEntry);
		if (ModConfig.enchantedToolsHaveEfficiency) {
