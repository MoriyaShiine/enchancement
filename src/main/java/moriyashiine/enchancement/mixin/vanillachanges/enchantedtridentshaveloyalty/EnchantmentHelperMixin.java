...
public class EnchantmentHelperMixin {
	...
	private static int enchancement$enchantedTridentsHaveLoyalty(int original, ItemStack stack) {
		if (ModConfig.enchantedTridentsHaveLoyalty && stack.isIn(ItemTags.TRIDENT_ENCHANTABLE) && !stack.isIn(ModItemTags.NO_LOYALTY) && stack.getOrDefault(ModDataComponentTypes.TOGGLEABLE_PASSIVE, false)) {
