...
public class ServerPlayNetworkHandlerMixin {
	...
	public boolean enchancement$dashQuickly(boolean value) {
		if (DashComponent.PACKET_IMMUNITIES.containsKey(player)) {
			return true;
		}
		return value;
	}
	...
	public boolean enchancement$dashWrongly(boolean value) {
		if (DashComponent.PACKET_IMMUNITIES.containsKey(player)) {
			return true;
		}
		return value;
