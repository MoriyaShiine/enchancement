...
public class ItemMixin {
	...
	private boolean enchancement$rebalanceConsumables(PlayerEntity instance, boolean ignoreHunger, Operation<Boolean> original, World world, PlayerEntity user, Hand hand) {
