...
public class RangedWeaponItemMixin {
	...
	private ProjectileEntity enchancement$teleportOnHit(ProjectileEntity original, ServerWorld world, LivingEntity shooter, Hand hand, ItemStack weaponStack) {
		TeleportOnHitComponent.maybeSet(shooter, weaponStack, original);
		return original;
	}
}
