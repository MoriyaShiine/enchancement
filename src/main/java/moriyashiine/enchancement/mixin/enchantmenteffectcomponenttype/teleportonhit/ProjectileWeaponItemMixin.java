...
public class ProjectileWeaponItemMixin {
	...
	private Projectile enchancement$teleportOnHit(Projectile original, ServerLevel level, LivingEntity shooter, InteractionHand hand, ItemStack weapon) {
		TeleportOnHitComponent.maybeSet(shooter, weapon, original);
		return original;
	}
}
