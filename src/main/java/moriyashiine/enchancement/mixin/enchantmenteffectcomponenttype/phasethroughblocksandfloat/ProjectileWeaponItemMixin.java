...
public class ProjectileWeaponItemMixin {
	...
	private Projectile enchancement$phaseThroughBlocksAndFloat(Projectile original, ServerLevel level, LivingEntity shooter, InteractionHand hand, ItemStack weapon) {
		PhaseThroughBlocksAndFloatComponent.maybeSet(shooter, weapon, original);
		return original;
	}
}
