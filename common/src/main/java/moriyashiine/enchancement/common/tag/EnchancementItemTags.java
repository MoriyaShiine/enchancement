...
public class EnchancementItemTags {
	public static final TagKey<Item> BREAKABLE = TagKey.create(Registries.ITEM, Enchancement.id("breakable"));
	public static final TagKey<Item> UNBREAKABLE = TagKey.create(Registries.ITEM, Enchancement.id("unbreakable"));
