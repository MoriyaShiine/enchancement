...
public class EnchancementDamageTypes {
	...
	public static void bootstrap(BootstrapContext<DamageType> registry) {
		registry.register(AMETHYST_SHARD, new DamageType("arrow", 0.1F));
		registry.register(BRIMSTONE, new DamageType("arrow", 0.1F));
		registry.register(ICE_SHARD, new DamageType("freeze", 0, DamageEffects.FREEZING));
		registry.register(LIFE_DRAIN, new DamageType("enchancement.life_drain", 0));
	}
}
