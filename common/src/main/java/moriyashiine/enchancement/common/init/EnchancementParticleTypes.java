...
public class EnchancementParticleTypes {
	...
	public static final ParticleType<HoneyBubbleParticleOption> HONEY_BUBBLE = registerParticleType("honey_bubble", FabricParticleTypes.complex(HoneyBubbleParticleOption.CODEC, HoneyBubbleParticleOption.STREAM_CODEC));
	...
	public static final ParticleType<SparkParticleOption> SPARK = registerParticleType("spark", FabricParticleTypes.complex(SparkParticleOption.CODEC, SparkParticleOption.STREAM_CODEC));
